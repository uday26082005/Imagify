...
const Description = () => {
    return (
        <motion.div
            ...
            viewport={{ once: true }}   
        >
            <h1 className="text-3xl sm:text-4xl font-semibold mb-2 dark:text-white">Create AI Images</h1>
            <p className="text-gray-500 dark:text-gray-400 mb-8">Turn your imagination into visuals</p>
            <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
                <img src={assets.sample_image_6} className="w-80 xl:w-96 rounded-lg" alt="" />
                <div>
                    <h2 className="text-3xl font-medium max-w-lg mb-4 dark:text-white">Introducing the AI-Powered Text to Image Generator</h2>
